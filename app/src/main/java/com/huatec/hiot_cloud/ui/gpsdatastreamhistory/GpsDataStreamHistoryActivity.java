...
public class GpsDataStreamHistoryActivity extends BaseActivity<GpsDataStreamHistoryView, GpsDataStreamHistoryPresenter> implements GpsDataStreamHistoryView, AMap.OnCameraChangeListener, AMap.OnInfoWindowClickListener, GeocodeSearch.OnGeocodeSearchListener, AMap.OnMapClickListener, AMap.OnMarkerClickListener {
    ...
    @BindView(R.id.toolbar_data_gps_histoty)
    Toolbar toolbarDataGpsHistoty;
    ...
    private void initView() {
        ...
        setSupportActionBar(toolbarDataGpsHistoty);
        getSupportActionBar().setDisplayHomeAsUpEnabled(true);
        toolbarDataGpsHistoty.setNavigationOnClickListener(new View.OnClickListener() {
            @Override
    ...
    public void showData(List<UpDataStreamGpsBean> dataList) {
        ...
        for (UpDataStreamGpsBean upDataStreamGpsBean : dataList) {
            ...
            aMap.animateCamera(CameraUpdateFactory.newCameraPosition(new CameraPosition(latLng,
                    15, 0, 0)), 100, null);
