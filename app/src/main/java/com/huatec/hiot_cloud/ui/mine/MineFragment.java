...
public class MineFragment extends BaseFragment<MineView, MinePresenter> implements MineView {
    ...
    @OnClick({R.id.iv_head_img, R.id.tv_user_center_update_password, R.id.tv_user_center_update_email, R.id.btn_logout})
...
//        Picture
    ...
    public void refreshUserInfo(UserBean userBean) {
        ImageUtils.showCircle(getActivity(), ivHeadImg, ImageUtils.getFullUrl(userBean.getImg()));
    ...
    public void refreshUserHead(String url) {
        ImageUtils.showCircle(getActivity(), ivHeadImg, ImageUtils.getFullUrl(url));
    }
